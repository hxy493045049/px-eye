...
public class FoodUEViewInfo {
    ...
    private FoodUEViewInfo parentElement;

    public FoodUEViewInfo(View view) {
        this.view = view;
        reset();
    ...
    @Nullable
    public FoodUEViewInfo getParentViewInfo() {
        if (parentElement == null) {
            Object parentView = view.getParent();
            if (parentView instanceof View) {
                parentElement = new FoodUEViewInfo((View) parentView);
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        FoodUEViewInfo info = (FoodUEViewInfo) o;
