...
public class PxeTakeColorView extends FrameLayout {
    ...
    public PxeTakeColorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PxeTakeColorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public void setTargetView(View rootView) {
        this.target = rootView;
    }

    @SuppressLint("NewApi")
    public PxeTakeColorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        colorView.post(() -> {
            ...
            param.leftMargin = (PxeDimensionUtils.getScreenWidth() - colorView.getWidth()) / 2;
            param.topMargin = (PxeDimensionUtils.getScreenHeight() - colorView.getHeight()) / 2;
...
//                    ((ViewGroup) getParent()).removeView(this);
    ...
    public class TakeColorView extends View implements PxeTakeColorView.OnMoveListener {
        ...
        private void init() {
            ...
            mPaint.setTextSize(PxeDimensionUtils.dip2px(12));
        }
