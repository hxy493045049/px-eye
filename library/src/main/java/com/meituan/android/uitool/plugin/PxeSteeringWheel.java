 ...
 * 2018/8/8 on 下午5:59
 */
public class PxeSteeringWheel extends AppCompatImageButton {
    ...
    public PxeSteeringWheel(Context context) {
        this(context, null);
    }

    public PxeSteeringWheel(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PxeSteeringWheel(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            center = PxeViewUtils.getCenter(this);
    ...
    public static class DefaultHandler extends Handler {
        private WeakReference<PxeSteeringWheel> wheelRef;
        ...
        private DefaultHandler(PxeSteeringWheel wheel) {
            wheelRef = new WeakReference<>(wheel);
        }

        @Override
        public void handleMessage(Message msg) {
            PxeSteeringWheel wheel = wheelRef.get();
