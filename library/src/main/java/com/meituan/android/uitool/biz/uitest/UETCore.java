...
import static com.meituan.android.uitool.utils.PxeDimensionUtils.px2sp;
...
public class UETCore implements IAttrs {
    ...
    public List<Item> getAttrs(Element element) {
        ...
        items.add(new TextItem("Id", PxeResourceUtils.getResId(view)));
        items.add(new TextItem("ResName", PxeResourceUtils.getResourceName(view.getId())));
    ...
    static class UETTextView implements IAttrs {
        ...
        public List<Item> getAttrs(Element element) {
            ...
            items.add(new EditTextItem("TextColor", element, EditTextItem.Type.TYPE_TEXT_COLOR, PxeResourceUtils.intToHexColor(textView.getCurrentTextColor())));
    ...
    static class UETImageView implements IAttrs {
        ...
        public List<Item> getAttrs(Element element) {
            ...
            items.add(new BitmapItem("Bitmap", PxeViewUtils.getImageViewBitmap(imageView)));
            items.add(new TextItem("ScaleType", PxeViewUtils.getImageViewScaleType(imageView)));
            return items;
        }
    }
}
