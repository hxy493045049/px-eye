...
public class FoodUEDimensionUtils {
    ...
    public static String px2dip(float pxValue, boolean withUnit) {
        float scale = FoodUETool.applicationContext.getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float sp) {
        return (int) TypedValue.applyDimension(2, sp, FoodUETool.applicationContext.getResources().getDisplayMetrics());
    }

    public static String px2sp(float pxValue) {
        final float fontScale = FoodUETool.applicationContext.getResources().getDisplayMetrics().scaledDensity;
        return String.valueOf((int) (pxValue / fontScale + 0.5f));
    }

    public static int getScreenWidth() {
        return FoodUETool.applicationContext.getResources().getDisplayMetrics().widthPixels;
    }

    public static int getScreenHeight() {
        return FoodUETool.applicationContext.getResources().getDisplayMetrics().heightPixels;
    }
